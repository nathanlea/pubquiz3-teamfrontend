  ...
  <div id="main">
    <nav-bar-part>
      <b-nav-item>
        ...
        <b-button size="sm" class="mr-1" @click="finishGame" variant="danger">
          <b-icon-power/>
          {{ $t("FINISH_GAME") }}
        </b-button>
      ...
      <template v-slot:rightcontent>
        ...
        <b-nav-item v-b-tooltip.hover to="/ranking" :title="$t('RANKING_TITLE')" target="_blank"
          >Rankings <b-icon-window/></b-nav-item>
      </template>
    </nav-bar-part>
...
import QmRankingPart from './qm-gameparts/QmRankingPart.vue';
...
@Component({
  components: { NavBarPart, FooterPart, QmQuestionPart, QmTeamFeedPart, QmRankingPart },
